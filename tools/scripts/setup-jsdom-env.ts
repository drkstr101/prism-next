// Add this file to your jest config (E.G `setupFilesAfterEnv: ['tools/scripts/setup-jsdom-env.ts']`)
import '@testing-library/jest-dom';

const IGNORE_ERROR_PATTERNS = ['ReactDOM.render is no longer supported in React 18'];
...
function setupJest() {
  console.info('Setting up jsdom test environment...');

  // register a mock NextJS router
